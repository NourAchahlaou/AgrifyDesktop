 ...
 */
public class ValeurNutritionnelBesoinNutritionnelEntity {
    ...
    public ValeurNutritionnelBesoinNutritionnelEntity() {
        // Default constructor
    }

    public ValeurNutritionnelBesoinNutritionnelEntity(double pb, double fb, double adf, double ndf, double ms, double eb, double ca, double p, double mg, double k) {
        this.pb = pb;
        this.fb = fb;
        this.adf = adf;
        this.ndf = ndf;
